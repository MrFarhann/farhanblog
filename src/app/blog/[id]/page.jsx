...
import style from "./pageBlog.module.css"
        ...
        <div className={style.container}>
            <div className={style.wrapper}>
                ...
                <div className={style.row}>
                    <h3 className={style.title}>{blogDetails?.title}</h3>
                    {
                        blogDetails?.authorId?._id.toString() === session?.user?._id.toString()
                            ? (
                                <div className={style.controls}>
                                    <Link className={style.editButton} href={`/blog/edit/${ctx.params.id}`}>
                    ...
                    <div className={style.comments}>
                        {
                            comments?.length > 0
                                ...
                                : <h4 className={style.noComments}>No comments. Be the first one to leave a comment!</h4>
                        }
                    </div>
                </div>
            </div>
